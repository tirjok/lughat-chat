...
<template>
  <div
    class="flex flex-col gap-4 bg-studio-900 rounded-[1.25rem] ring-1 ring-white/[0.06] p-4 shadow-[inset_0_1px_1px_rgba(255,255,255,0.06)]"
  >
    <div class="flex justify-between items-end">
      ...
      <span class="text-xs font-mono text-sunrise-orange bg-studio-800 px-2 py-1 rounded-lg ring-1 ring-white/[0.06]">
        {{ displayValue }}
      </span>
    </div>
    ...
    <div class="md:hidden flex items-center justify-center gap-4">
      <button
        class="w-11 h-11 rounded-full bg-studio-700 ring-1 ring-white/[0.06] text-white flex items-center justify-center shadow-[0_4px_12px_rgba(0,0,0,0.2)] hover:bg-studio-600 active:scale-95 transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)]"
      ...
      <span class="text-xl font-mono text-sunrise-orange bg-studio-900 px-4 py-2 rounded-lg ring-1 ring-white/[0.06] min-w-[4rem] text-center">
        {{ displayValue }}
      </span>
