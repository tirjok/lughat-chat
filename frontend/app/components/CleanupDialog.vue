...
<template>
  ...
  >
    <div class="bg-studio-800 rounded-xl p-6 max-w-md w-full mx-4 ring-1 ring-white/[0.06] shadow-[0_32px_64px_rgba(0,0,0,0.5)]">
      <h3
      ...
      <div class="flex gap-3 justify-end">
        <button
          ...
          class="px-4 py-2 rounded-lg bg-sunrise-magenta text-white text-sm font-medium hover:bg-sunrise-magenta/80 transition-colors focus:outline-none focus:ring-2 focus:ring-sunrise-magenta"
          @click="emit('cleanup')"
        >
          Clean &amp; Leave
        </button>
