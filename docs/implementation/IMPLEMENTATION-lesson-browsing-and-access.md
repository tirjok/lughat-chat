...
1. **Content data gap** (RC-1): Only 1 of 30 lesson JSON files exists. Should creating the remaining 29 lesson files be a separate issue, or is it a data gap outside the scope of implementation?
