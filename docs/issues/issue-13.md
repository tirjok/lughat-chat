...
A toast notification component that displays error messages at the top-center of the screen. It should be dismissible with an X button and support smooth enter/leave animations.

The component should:
- Accept a message string as input
- Display with LTR layout support
...
- [ ] Component accepts a message string and displays it in English
...
- [ ] LTR layout support (text alignment, icon positioning)
